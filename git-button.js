(function(window, $, undefined){  
	...
	var PLUGIN_INTERVAL = setInterval(setup, 500);

	function setup() {

		var targets = document.querySelectorAll('.tn-panel__loom');
